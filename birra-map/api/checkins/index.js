...
module.exports = S.withMember(async (context, req, p, m) => {
  ...
  S.ok(context, { now, active, home,
    rounds: rounds.slice(0,20).map(r => ({ id:r.rowKey, payerId:r.payerId, payerNick:r.payerNick,
      drink:r.drink, place:r.place, ts:r.ts, tsMs:r.tsMs,
