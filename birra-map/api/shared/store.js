...
/* Usuario autenticado: cabecera que inyecta Static Web Apps */
...
async function listCheckins(groupId, sinceMs, untilMs = null) {
  ...
  return out;   // ya vienen del más nuevo al más viejo (RowKey invertido)
}
...
/* Envoltorio: resuelve auth + grupo y captura errores */
function withMember(handler) {
  return async function (context, req) {
    try {
      ...
      context.log && context.log.error ? context.log.error(e) : console.error(e);
