...
/* GET/POST /api/me
   Devuelve errores explicativos en vez de un 500 pelado. */
module.exports = async function (context, req) {
  try {
    ...
    S.ok(context, {
      userId: p.userId, nick: m.nick || null, groupId: m.groupId || null,
    ...
    /* Si es un problema de configuración, se dice claramente y se manda al diagnóstico */
    if (e.birramapConfig) {
      return S.err(context, 503, e.message, { diagnostico: '/diag.html' });
    }
